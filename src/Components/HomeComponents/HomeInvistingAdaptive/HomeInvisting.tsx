...
import { HomeInvistingWrap2, HomeInvistingOption2, HomeInvistingOptionText, HomeInvistingItem2, HomeInvisting2Title, HomeInvisting2Text } from '../HomeInvisting/HomeInvistingSC'
