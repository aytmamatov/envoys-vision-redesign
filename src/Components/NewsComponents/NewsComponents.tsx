...
import { NCWrap, NCtitle, NCBody, NCLargeItem, NCImage, NCContent, NCContentSubtitle, NCContentTitle, NCContentDate, NCContentMore, NCItem, NCItemImage, NCItemContent, NCItemSubtitle, NCItemTitle } from './NewsComponentsSC';
